...
export const Contact = () => {
  ...
  return (
    <div className="h-screen mb-auto">
      <section className="relative z-10  bg-gray-100 py-20 lg:py-[120px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">
                      RM Business Street, 123 Hernan Cortes St, Mandaue City,
                      Cebu
                    </p>
                  </div>
                </div>
                ...
                <form ref={form} onSubmit={sendEmail}>
                  ...
                  <div>
                    <button
                      type="submit"
                      value="Send"
                      className="bg-gray-200 border-gray-400 w-full rounded border p-3 text-gray-900 transition hover:bg-opacity-90 hover:bg-gray-700 hover:text-white"
                      onClick={() => {
                        alert("Message Sent!");
                      }}
                    >
